function [ERROR,job] = reslice(source,target,obj)
...
jobs{1}.spm.spatial.coreg.estwrite.ref = crg.ref;%{'01GI.nii,1'}
jobs{1}.spm.spatial.coreg.estwrite.source = crg.source;
jobs{1}.spm.spatial.coreg.estwrite.other = {crg.other};
jobs{1}.spm.spatial.coreg.estwrite.eoptions = struct('cost_fun',crg.cfun,'sep',crg.sep,'tol',crg.tol,'fwhm', crg.fwhm);
jobs{1}.spm.spatial.coreg.estwrite.roptions = struct('interp',7,'wrap',[0 0 0],'mask',0,'prefix','r');
