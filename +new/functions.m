function functions(fname,developer,obj)
%% NEW.FUNCTIONS: Creates function files based on template in the right folder 
%
%    __           _             
%   / _|         (_)            
...
if ischar(developer)||isempty(developer)
    switch developer
        ...
        case 'ines';dev = {'Inês Violante';'i.violante@imperial.ac.uk';'Imperial College London'};
        otherwise;dev = {' ';' ';' '};
    end
else
    dev = developer;
